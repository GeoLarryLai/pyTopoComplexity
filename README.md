...
This repository contains a set of codes for (1) measuring the topographic complexity (i.e., surface roughness) of a land surface, and (2) simulating topographic smoothing by non-linear hillslope diffusion processes.
