...
The Mexican Hat Wavelet Tranform code (writen in MATLAB) code was originally developed from Dr. Adam M. Booth (Portland State Univeristy).
  Citations:
...
In November, 2023, this MATLAB code was optimized by Dr. Larry Syu-Heng Lai (Univeristy of Washington). It is further translated into a python version.
  Citations: TBA
